...
class AuthenticationsHandler {
  ...
  async putAuthenticationHandler(request, h) {
    ...
    await this._authenticationService.verifyRefreshToken(
      refreshTokenValidated.refreshToken,
    );
  ...
  async deleteAuthenticationHandler(request, h) {
    const refreshTokenValidated = this._validator.validateDeleteAuthenticationPayload(
      request.payload,
    );
    ...
    await this._authenticationService.deleteRefreshToken(
      refreshTokenValidated.refreshToken,
    );
