...
class PlaylistHandler {
  ...
  async deletePlaylistSongHandler(request, h) {
    const songIdValidated = this._validator.validatePlaylistSongPayload(
      request.payload,
    );
  ...
  async postPlaylistHandler(request, h) {
    const playlistValidated = this._validator.validatePlaylistPayload(
      request.payload,
    );
